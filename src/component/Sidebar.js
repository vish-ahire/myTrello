...
const Sidebar = () => {
    ...
    useEffect(() => {
        const handleResize = () => (window.innerWidth <= 768) ? setCollapsed(true) : setCollapsed(false);
        handleResize(); 
    ...
    return (
        <div className={`bg-[#121417] h-[calc(100vh-6rem)] border-r border-r-[#9fadbc29] transition-all linear duration-500 flex-shrink-0 ${collapsed ? 'w-[42px]' : 'w-[280px]'}`} >
